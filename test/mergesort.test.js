...
describe('Merge sort', () => {
    it('Empty is sorted', () => {
        expect(mergesort([])).deep.equals([]);
    });

    it('One element is sorted', () => {
        expect(mergesort([3])).deep.equals([3]);
    });

    it('Sorted is sorted', () => {
        expect(mergesort([1, 2, 3])).deep.equals([1, 2, 3]);
    });

    it('Two elements are sorted', () => {
        expect(mergesort([3, 1])).deep.equals([1, 3]);
    });

    it('sort four descending elements', () => {
        expect(mergesort([4, 3, 2, 1])).deep.equals([1, 2, 3, 4]);
    });

    it('sort five', () => {
        expect(mergesort([5, 4, 3, 2, 1])).deep.equals([1, 2, 3, 4, 5]);
    });

    it('sort six', () => {
        expect(mergesort([6, 4, 5, 3, 2, 1])).deep.equals([1, 2, 3, 4, 5, 6]);
    });
